...
def informazioni(mydb,id,id_stampante):
    ...
    EC_cliente.insert(0,E_cliente(mydb,id))
    EC_cliente.pack()
    ...
    EC_dataconsegna.insert(0, E_dataconsegna(mydb, id_stampante , "ciano"))
    ...
    EC_contatore.pack()
    EC_contatore.insert(0, E_contatore(mydb, id_stampante, "ciano"))
    ...
    EC_rprevisione.pack()
    EC_rprevisione.insert(0, E_previsione(mydb, id_stampante, "ciano"))
    ...
    EC_datascorta.pack()
    EC_datascorta.insert(0, E_datascorta(mydb,id_stampante, "ciano"))
    ...
    EC_scorta.pack()
    EC_scorta.insert(0, E_scorta(mydb,id_stampante, "ciano"))
